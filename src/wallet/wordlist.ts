/**
 * BIP-39 English wordlist: 2048 words, sorted, unique within their first
 * four letters. Byte-identical to bip-0039/english.txt in the BIPs repository
 * (sha256 2f5eed53a4727b4bf8880d8f3f199efc90e58503646d9ff8eff3a2ed3b24dbda over
 * the newline-terminated file); tests/wallet/mnemonic.test.ts re-checks that hash.
 */
